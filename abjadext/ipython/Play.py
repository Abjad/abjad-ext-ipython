...
class Play(object):
    ...
    def __call__(self, argument):
        ...
        with tempfile.TemporaryDirectory() as temporary_directory:
            ...
            encoded_audio = self._get_audio_as_base64(
                midi_file_path, audio_file_path, has_vorbis
            )
    ...
    def _get_audio_as_base64(self, midi_path, audio_path, has_vorbis):
        if has_vorbis:
            output_flag = "-Ov"
        else:
            output_flag = "-Oa"
    ...
    def _run_timidity(self, midi_path, audio_path, output_flag):
        ...
        command = command.format(
            midi_path=midi_path, output_flag=output_flag, audio_path=audio_path
        )
